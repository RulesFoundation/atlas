...
- UK CLML to Arch models (UK legislation from legislation.gov.uk)
- eCFR to Arch models (US federal regulations from ecfr.gov)
- Canadian laws-lois-xml to Arch models (Canadian federal legislation from GitHub)
"""
...
from atlas.converters.uk_clml import UKCLMLConverter, fetch_uk_legislation
