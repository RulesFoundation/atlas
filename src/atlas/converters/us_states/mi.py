...
Usage:
    >>> from atlas.converters.us_states.mi import MichiganConverter
...
class MichiganConverter:
    ...
    structured Python objects. Supports conversion to Arch Section models.
    ...
    def to_arch_sections(self, chapter: MCLChapter) -> Iterator[Section]:
        """Convert MCL chapter to Arch Section models.

        Args:
            chapter: Parsed MCLChapter

        Yields:
            Section objects compatible with Arch storage
        """
    ...
    def _convert_subsection(self, sub: MCLSubsection) -> Subsection:
        """Convert MCL subsection to Arch Subsection model.

        Args:
            sub: MCLSubsection object

        Returns:
            Arch Subsection model
        """
        children = [
