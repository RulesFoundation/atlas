...
and converts them to USLM-style XML format for ingestion into the Arch database.

API Documentation: https://legislation.nysenate.gov/static/docs/html/laws.html

Usage:
    >>> from atlas.converters.us_states.ny import NYStateConverter
...
class NYStateConverter:
    ...
    def to_section_model(self, result: NYFetchResult):
        """Convert NYFetchResult to Arch Section model.
