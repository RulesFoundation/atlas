...
class RegulationStorage:
    ...
    def __init__(self, db_path: Path | str = "arch.db"):
    ...
    def get_by_citation(self, citation: CFRCitation) -> Optional[Regulation]:
    ...
    def count_regulations(self, title: Optional[int] = None) -> int:
